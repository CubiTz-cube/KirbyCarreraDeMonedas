...
import src.world.entities.blocks.*;
...
public class EntityFactory {
    ...
    public Entity create(Entity.Type type, World world, Vector2 position, Integer id){
        ...
        return switch (type) {
            ...
            case WATERBLOCKD -> new WaterBlock(world, new Rectangle(position.x, position.y, 1f, 1f), assetManager, id, Entity.Type.WATERBLOCKD);
            case WATERBLOCKL -> new WaterBlock(world, new Rectangle(position.x, position.y, 1f, 1f), assetManager, id, Entity.Type.WATERBLOCKL);
            case WATERBLOCKR -> new WaterBlock(world, new Rectangle(position.x, position.y, 1f, 1f), assetManager, id, Entity.Type.WATERBLOCKR);
