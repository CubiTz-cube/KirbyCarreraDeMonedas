...
public class SwordProyectile extends Projectil{
    private Float timeDespawn;

    public SwordProyectile(World world, Rectangle shape, AssetManager assetManager, Integer id, Type type, GameScreen game, Texture texture) {
